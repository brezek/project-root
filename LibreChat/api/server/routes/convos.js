...
// Add the middleware to the conversation routes
router.post('/update', getResearchContext, async (req, res) => {
  ...
  // Add research context to the conversation if available
  if (req.researchContext) {
    update.researchContext = req.researchContext;
  }
